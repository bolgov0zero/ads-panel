...
if [ $? -ne 0 ]; then
    echo -e "\e[31m[✗]\e[0m Загрузка архива. Ошибка: Не удалось скачать ads.zip"
    exit 1
fi

sleep 2
echo -e "\e[32m[✓]\e[0m Загрузка архива."

# Этап 2: Распаковка архива
echo -ne "[ ] Распаковка архива.\r"
rm -r ads > /dev/null 2>&1
unzip ads.zip > /dev/null 2>&1
rm ads.zip > /dev/null 2>&1

if [ $? -ne 0 ]; then
    echo -e "\e[31m[✗]\e[0m Распаковка архива. Ошибка: Не удалось распаковать ads.zip"
    exit 1
fi
sleep 2
echo -e "\e[32m[✓]\e[0m Распаковка архива."
